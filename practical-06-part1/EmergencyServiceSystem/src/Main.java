...
public class Main {
        ...
        switch (_option) {
            case 1:
                ...
                while (true) {
                    ...
                    if (triageLevelMatches(triageLevel)) {
                        break;
                    }else {
                        System.out.println("Wrong input! Please input an integer among 1 to 5!");
                    }
                }
            ...
            case 4:
                ...
                serviceCenter.checkPositionById();
                waitInput(inputScan);
                break;
            case 5:
                clearScreen();
    ...
    private static boolean triageLevelMatches(String string) {
        return "1".equals(string)||"2".equals(string)||"3".equals(string)||"4".equals(string)||"5".equals(string);
    }
