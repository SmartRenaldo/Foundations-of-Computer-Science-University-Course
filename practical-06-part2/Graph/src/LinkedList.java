public class LinkedList {
    ...
    public void print() {
        if (this.head == null) {
            ...
            while (tmp != null) {
                ...
                if (tmp.getNext() != null) {
                    System.out.print("Node " + tmp.getIndex() + " -> ");
                } else {
                    System.out.println("Node " + tmp.getIndex());
                }
    ...
    public void delete(int value) {
        ...
        } else if (this.head.getIndex() == value) { // if we need to remove head
        ...
        while (tmp != null && tmp.getIndex() != value) { // true && false -> false
            // false && ? -> false
            // false && ? -> false
            // true && true -> true
            prev = tmp;
